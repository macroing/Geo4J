...
public final class InfiniteBoundingVolume3FUnitTests {
	...
	public void testConstants() {
		...
		assertEquals("Infinite Bounding Volume", InfiniteBoundingVolume3F.NAME);
	}
	...
	public void testGetName() {
		...
		assertEquals(InfiniteBoundingVolume3F.NAME, infiniteBoundingVolume.getName());
	}
	...
	public void testMax() {
		...
		final Point3F b = infiniteBoundingVolume.max();
	...
	public void testMidpoint() {
		...
		final Point3F b = infiniteBoundingVolume.midpoint();
	...
	public void testMin() {
		...
		final Point3F b = infiniteBoundingVolume.min();
