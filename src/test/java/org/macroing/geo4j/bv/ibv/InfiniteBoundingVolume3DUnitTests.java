...
public final class InfiniteBoundingVolume3DUnitTests {
	...
	public void testConstants() {
		...
		assertEquals("Infinite Bounding Volume", InfiniteBoundingVolume3D.NAME);
	}
	...
	public void testGetName() {
		...
		assertEquals(InfiniteBoundingVolume3D.NAME, infiniteBoundingVolume.getName());
	}
	...
	public void testMax() {
		...
		final Point3D b = infiniteBoundingVolume.max();
	...
	public void testMidpoint() {
		...
		final Point3D b = infiniteBoundingVolume.midpoint();
	...
	public void testMin() {
		...
		final Point3D b = infiniteBoundingVolume.min();
