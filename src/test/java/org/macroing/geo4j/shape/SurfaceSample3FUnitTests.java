...
public final class SurfaceSample3FUnitTests {
	...
	public void testConstructor() {
		final SurfaceSample3F surfaceSample = new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), new Vector3F(1.0F, 0.0F, 0.0F), 1.0F);
		...
		assertThrows(NullPointerException.class, () -> new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), null, 1.0F));
		assertThrows(NullPointerException.class, () -> new SurfaceSample3F(null, new Vector3F(1.0F, 0.0F, 0.0F), 1.0F));
	}
	
	@Test
	public void testEquals() {
		final SurfaceSample3F a = new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), new Vector3F(1.0F, 0.0F, 0.0F), 1.0F);
		final SurfaceSample3F b = new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), new Vector3F(1.0F, 0.0F, 0.0F), 1.0F);
		final SurfaceSample3F c = new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), new Vector3F(1.0F, 0.0F, 0.0F), 2.0F);
		final SurfaceSample3F d = new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), new Vector3F(0.0F, 1.0F, 0.0F), 1.0F);
		final SurfaceSample3F e = new SurfaceSample3F(new Point3F(2.0F, 3.0F, 4.0F), new Vector3F(1.0F, 0.0F, 0.0F), 1.0F);
		final SurfaceSample3F f = null;
	...
	public void testGetSurfaceNormal() {
		final SurfaceSample3F a = new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), new Vector3F(1.0F, 0.0F, 0.0F), 1.0F);
		final SurfaceSample3F b = new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), new Vector3F(2.0F, 0.0F, 0.0F), 1.0F);
	...
	public void testToString() {
		...
		assertEquals("new SurfaceSample3F(new Point3F(1.0F, 2.0F, 3.0F), new Vector3F(1.0F, 0.0F, 0.0F), 1.0F)", surfaceSample.toString());
	}
	
	@Test
	public void testTransformSurfaceSample3FMatrix44F() {
		final SurfaceSample3F a = new SurfaceSample3F(new Point3F(0.0F, 0.0F, 0.0F), new Vector3F(1.0F, 0.0F, 0.0F), 1.0F);
