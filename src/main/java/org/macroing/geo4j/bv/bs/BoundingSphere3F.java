...
public final class BoundingSphere3F implements BoundingVolume3F {
	/**
	 * The name used by this {@code BoundingSphere3F} class.
	 */
	public static final String NAME = "BoundingSphere";
	
	/**
	 * The ID used by this {@code BoundingSphere3F} class.
	 */
	 ...
	 * <p>
	 * Returns a {@code BoundingSphere3F} instance with the result of the transformation.
	 * <p>
	 ...
	 * @return a {@code BoundingSphere3F} instance with the result of the transformation
	...
	public BoundingSphere3F transform(final Matrix44F matrix) {
		final Point3F center = matrix.transformAndDivide(this.center);
		final Point3F x = matrix.transformAndDivide(new Point3F(this.center.x + this.radius, this.center.y, this.center.z));
		final Point3F y = matrix.transformAndDivide(new Point3F(this.center.x, this.center.y + this.radius, this.center.z));
		final Point3F z = matrix.transformAndDivide(new Point3F(this.center.x, this.center.y, this.center.z + this.radius));
	...
	/**
	 * Returns a {@code String} with the name of this {@code BoundingSphere3F} instance.
	 * 
	 * @return a {@code String} with the name of this {@code BoundingSphere3F} instance
	 */
	@Override
	...
	public String toString() {
		return String.format("new BoundingSphere3F(%s, %s)", Strings.toNonScientificNotationJava(this.radius), this.center);
	}
