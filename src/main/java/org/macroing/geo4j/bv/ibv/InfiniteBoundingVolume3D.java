...
public final class InfiniteBoundingVolume3D implements BoundingVolume3D {
	/**
	 * The name used by this {@code InfiniteBoundingVolume3D} class.
	 */
	public static final String NAME = "Infinite Bounding Volume";
	
	/**
	 * The ID used by this {@code InfiniteBoundingVolume3D} class.
	 */
	...
	/**
	 * Returns a {@code String} with the name of this {@code InfiniteBoundingVolume3D} instance.
	 * 
	 * @return a {@code String} with the name of this {@code InfiniteBoundingVolume3D} instance
	 */
	@Override
