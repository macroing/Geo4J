...
public final class InfiniteBoundingVolume3F implements BoundingVolume3F {
	/**
	 * The name used by this {@code InfiniteBoundingVolume3F} class.
	 */
	public static final String NAME = "Infinite Bounding Volume";
	
	/**
	 * The ID used by this {@code InfiniteBoundingVolume3F} class.
	 */
	...
	/**
	 * Returns a {@code String} with the name of this {@code InfiniteBoundingVolume3F} instance.
	 * 
	 * @return a {@code String} with the name of this {@code InfiniteBoundingVolume3F} instance
	 */
	@Override
