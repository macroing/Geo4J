...
/**
 * A {@code BoundingVolume3F} represents a 3-dimensional bounding volume that operates on {@code float}-based data types.
 * <p>
...
public interface BoundingVolume3F extends BoundingVolume {
	 ...
	 * <p>
	 * Returns a {@code BoundingVolume3F} instance with the result of the transformation.
	 * <p>
	 ...
	 * @return a {@code BoundingVolume3F} instance with the result of the transformation
