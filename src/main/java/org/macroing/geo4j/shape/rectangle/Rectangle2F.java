...
import org.macroing.geo4j.shape.circle.Circle2F;
import org.macroing.geo4j.shape.ls.LineSegment2F;
...
public final class Rectangle2F implements Shape2F {
	...
	public static Rectangle2F fromPoints(final Point2F... points) {
		...
		Point2F max = Point2F.MIN;
		Point2F min = Point2F.MAX;
		
		for(final Point2F point : points) {
			max = Point2F.max(max, point);
			min = Point2F.min(min, point);
		}
		
		return new Rectangle2F(max, min);
	}
	...
	public static Rectangle2F rotate(final Rectangle2F rectangle, final AngleF angle) {
		final Point2F a = Point2F.rotateCounterclockwise(rectangle.a, angle.getRadians(), true);
		final Point2F b = Point2F.rotateCounterclockwise(rectangle.b, angle.getRadians(), true);
		final Point2F c = Point2F.rotateCounterclockwise(rectangle.c, angle.getRadians(), true);
		final Point2F d = Point2F.rotateCounterclockwise(rectangle.d, angle.getRadians(), true);
	...
	public static Rectangle2F union(final Rectangle2F a, final Rectangle2F b) {
		final Point2F min = Point2F.min(Point2F.min(a.getA(), a.getB(), a.getC(), a.getD()), Point2F.min(b.getA(), b.getB(), b.getC(), b.getD()));
		final Point2F max = Point2F.max(Point2F.max(a.getA(), a.getB(), a.getC(), a.getD()), Point2F.max(b.getA(), b.getB(), b.getC(), b.getD()));
		
		return new Rectangle2F(min, max);
	}
