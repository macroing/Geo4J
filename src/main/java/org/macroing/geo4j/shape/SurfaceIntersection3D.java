...
//	TODO: Add Unit Tests!
	 ...
	 * <p>
	 * If either {@code orthonormalBasisG}, {@code orthonormalBasisS}, {@code textureCoordinates}, {@code surfaceIntersectionPoint}, {@code ray}, {@code shape} or {@code surfaceIntersectionPointError} are {@code null}, a {@code NullPointerException} will be thrown.
	 * 
	 ...
	 * @throws NullPointerException thrown if, and only if, either {@code orthonormalBasisG}, {@code orthonormalBasisS}, {@code textureCoordinates}, {@code surfaceIntersectionPoint}, {@code ray}, {@code shape} or {@code surfaceIntersectionPointError} are {@code null}
	 */
//	TODO: Add Unit Tests!
...
//	TODO: Add Unit Tests!
	public static SurfaceIntersection3D transform(final SurfaceIntersection3D surfaceIntersection, final Matrix44D matrix, final Matrix44D matrixInverse) {
		...
		final OrthonormalBasis33D orthonormalBasisGNewSpace = orthonormalBasisGOldSpace.transformTranspose(matrixInverse);
		final OrthonormalBasis33D orthonormalBasisSNewSpace = orthonormalBasisSOldSpace.transformTranspose(matrixInverse);
		...
		final Point3D surfaceIntersectionPointNewSpace = matrix.transformAndDivide(surfaceIntersectionPointOldSpace);
		
		final Ray3D rayOldSpace = surfaceIntersection.ray;
		final Ray3D rayNewSpace = matrix.transform(rayOldSpace);
		
		final Shape3D shape = surfaceIntersection.shape;
		
		final Vector3D surfaceIntersectionPointErrorOldSpace = surfaceIntersection.surfaceIntersectionPointError;
		final Vector3D surfaceIntersectionPointErrorNewSpace = matrix.transformError(surfaceIntersectionPointOldSpace, surfaceIntersectionPointErrorOldSpace);
