...
import org.macroing.geo4j.shape.rectangle.Rectangle2F;
...
public final class Polygon2F implements Shape2F {
	...
	/**
	 * Returns a {@code List} that contains all {@link Point2F} instances in this {@code Polygon2F} instance.
	 * 
	 * @return a {@code List} that contains all {@code Point2F} instances in this {@code Polygon2F} instance
	 */
	public List<Point2F> getPoints() {
		return new ArrayList<>(java.util.Arrays.asList(this.points));
	}
	...
	public Point2F getPoint(final int index) {
		Ints.requireRange(index, 0, getPointCount() - 1, "index");
	...
	public boolean equals(final Object object) {
		if(object == this) {
			...
			return false;
		} else if(!java.util.Arrays.equals(this.points, Polygon2F.class.cast(object).points)) {
			return false;
		} else {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return Objects.hash(Integer.valueOf(java.util.Arrays.hashCode(this.points)));
	}
