...
//	TODO: Add Unit Tests!
	...
	public boolean equals(final Object object) {
		if(object == this) {
			...
			return false;
		} else if(!java.util.Arrays.equals(this.points, Polygon3F.class.cast(object).points)) {
			return false;
...
//	TODO: Add Unit Tests!
	@Override
	public int hashCode() {
		return Objects.hash(Integer.valueOf(java.util.Arrays.hashCode(this.points)), this.projectedPolygon, this.surfaceNormal);
	}
...
//	TODO: Add Unit Tests!
	...
	private Point2F doCreateTextureCoordinates(final Point3F surfaceIntersectionPoint) {
		final Vector3F surfaceNormalAbs = Vector3F.abs(this.surfaceNormal);
