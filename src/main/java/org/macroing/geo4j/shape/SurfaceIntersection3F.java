...
//	TODO: Add Unit Tests!
	 ...
	 */
//	TODO: Add Unit Tests!
	public SurfaceIntersection3F(final OrthonormalBasis33F orthonormalBasisG, final OrthonormalBasis33F orthonormalBasisS, final Point2F textureCoordinates, final Point3F surfaceIntersectionPoint, final Ray3F ray, final Shape3F shape, final float t) {
...
//	TODO: Add Unit Tests!
	public Ray3F createRay(final Point3F point) {
		return createRay(Vector3F.direction(this.surfaceIntersectionPoint, point));
	}
...
//	TODO: Add Unit Tests!
	public Ray3F createRay(final Vector3F direction) {
		return new Ray3F(this.surfaceIntersectionPoint, direction);
	}
...
//	TODO: Add Unit Tests!
	...
	public String toString() {
		return String.format("new SurfaceIntersection3F(%s, %s, %s, %s, %s, %s, %+.10f)", this.orthonormalBasisG, this.orthonormalBasisS, this.textureCoordinates, this.surfaceIntersectionPoint, this.ray, this.shape, Float.valueOf(this.t));
	}
...
//	TODO: Add Unit Tests!
	@Override
	public int hashCode() {
		return Objects.hash(this.orthonormalBasisG, this.orthonormalBasisS, this.textureCoordinates, this.surfaceIntersectionPoint, this.ray, this.shape, Float.valueOf(this.t));
	}
...
//	TODO: Add Unit Tests!
	public static SurfaceIntersection3F orient(final SurfaceIntersection3F surfaceIntersection, final Vector3F direction) {
		if(Vector3F.dotProduct(direction, surfaceIntersection.getOrthonormalBasisG().w) >= 0.0F) {
			...
			return new SurfaceIntersection3F(orthonormalBasisG, orthonormalBasisS, textureCoordinates, surfaceIntersectionPoint, ray, shape, t);
		}
...
//	TODO: Add Unit Tests!
	public static SurfaceIntersection3F transform(final SurfaceIntersection3F surfaceIntersection, final Matrix44F matrix, final Matrix44F matrixInverse) {
		...
		final OrthonormalBasis33F orthonormalBasisGNewSpace = orthonormalBasisGOldSpace.transformTranspose(matrixInverse);
		final OrthonormalBasis33F orthonormalBasisSNewSpace = orthonormalBasisSOldSpace.transformTranspose(matrixInverse);
		...
		final Point3F surfaceIntersectionPointNewSpace = matrix.transformAndDivide(surfaceIntersectionPointOldSpace);
		
		final Ray3F rayOldSpace = surfaceIntersection.ray;
		final Ray3F rayNewSpace = matrix.transform(rayOldSpace);
