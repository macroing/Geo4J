...
public final class Triangle2F implements Shape2F {
	...
	public boolean contains(final Point2F point) {
		final float signA = (point.x - this.b.x) * (this.a.y - this.b.y) - (this.a.x - this.b.x) * (point.y - this.b.y);
		final float signB = (point.x - this.c.x) * (this.b.y - this.c.y) - (this.b.x - this.c.x) * (point.y - this.c.y);
		final float signC = (point.x - this.a.x) * (this.c.y - this.a.y) - (this.c.x - this.a.x) * (point.y - this.a.y);
