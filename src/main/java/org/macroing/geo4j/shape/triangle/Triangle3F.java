...
//	TODO: Add Unit Tests!
	...
	public BoundingVolume3F getBoundingVolume() {
		final Point3F a = Point3F.min(new Point3F(this.a.getPosition()), new Point3F(this.b.getPosition()), new Point3F(this.c.getPosition()));
		final Point3F b = Point3F.max(new Point3F(this.a.getPosition()), new Point3F(this.b.getPosition()), new Point3F(this.c.getPosition()));
...
//	TODO: Add Unit Tests!
	...
	public Optional<SurfaceSample3F> sample(final Point2F sample) {
		...
		final Point3F barycentricCoordinates = Point3F.sampleTriangleUniformDistribution(sample);
...
//		TODO: Add Unit Tests!
		public static Vertex3F transform(final Vertex3F vertex, final Matrix44F matrix, final Matrix44F matrixInverse) {
			...
			final Point4F position = matrix.transform(vertex.position);
			
			final Vector3F normal = Vector3F.normalize(matrixInverse.transformTranspose(vertex.normal));
...
//		TODO: Add Unit Tests!
		public static Vertex3F transformAndDivide(final Vertex3F vertex, final Matrix44F matrix, final Matrix44F matrixInverse) {
			...
			final Point4F position = matrix.transformAndDivide(vertex.position);
...
//		TODO: Add Unit Tests!
	...
	private Point2F doCreateTextureCoordinates(final Point3F pBC) {
		final Point2F pTCA = this.a.getTextureCoordinates();
		final Point2F pTCB = this.b.getTextureCoordinates();
		final Point2F pTCC = this.c.getTextureCoordinates();
